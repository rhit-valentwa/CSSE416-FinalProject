...
class Level1(tools._State):
    ...
    def setup_enemies(self):
        ...
        goomba0 = enemies.Goomba(x=193)
        goomba1 = enemies.Goomba(x=193)
        goomba2 = enemies.Goomba(x=193)
        goomba3 = enemies.Goomba(x=193)
        goomba4 = enemies.Goomba(x=193)
        goomba5 = enemies.Goomba(x=193)
        goomba6 = enemies.Goomba(x=193)
        goomba7 = enemies.Goomba(x=193)
        goomba8 = enemies.Goomba(x=193)
        goomba9 = enemies.Goomba(x=193)
        goomba10 = enemies.Goomba(x=193)
        goomba11 = enemies.Goomba(x=193)
        goomba12 = enemies.Goomba(x=193)
        goomba13 = enemies.Goomba(x=193)
        goomba14 = enemies.Goomba(x=193)
        goomba15 = enemies.Goomba(x=193)
        goomba16 = enemies.Goomba(x=193)
    ...
    def setup_checkpoints(self):
        ...
        # Random goomba spawns for later
        # check1 = checkpoint.Checkpoint(random.randint(510,8775), "1")
        # check2 = checkpoint.Checkpoint(random.randint(510,8775), '2')
        # check3 = checkpoint.Checkpoint(random.randint(510,8775), '3')
        # check4 = checkpoint.Checkpoint(random.randint(510,8775), '4')
        # check5 = checkpoint.Checkpoint(random.randint(510,8775), '5')
        # check6 = checkpoint.Checkpoint(random.randint(510,8775), '6')
        # check7 = checkpoint.Checkpoint(random.randint(510,8775), '7')
